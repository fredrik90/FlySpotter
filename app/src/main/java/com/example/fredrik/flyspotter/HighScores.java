...
public class HighScores extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Objects.equals(highscores.getDate(0), "")){
        ...
        if (!Objects.equals(highscores.getDate(1), "")) {
        ...
        if (!Objects.equals(highscores.getDate(2), "")) {
        ...
        if (!Objects.equals(highscores.getDate(3), "")) {
        ...
        if (!Objects.equals(highscores.getDate(4), "")) {
        ...
        if (!Objects.equals(highscores.getDate(5), "")) {
        ...
        if (!Objects.equals(highscores.getDate(6), "")) {
        ...
        if (!Objects.equals(highscores.getDate(7), "")) {
        ...
        if (!Objects.equals(highscores.getDate(8), "")) {
        ...
        if (!Objects.equals(highscores.getDate(9), "")) {
